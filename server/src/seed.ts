...
const seedDB = async () => {
  try {
    await mongoose.connect(process.env.MONGO_URI || "mongodb://localhost:27017/vericode");
    console.log("🔥 Connected. Wiping old problems...");
    await Problem.deleteMany({});
    
    console.log("🌱 Seeding 20 Perfect Problems...");
    await Problem.insertMany(problems);
    
    console.log("✅ Done! 20 Problems ready.");
